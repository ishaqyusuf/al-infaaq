...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 rounded-lg text-sm font-semibold whitespace-nowrap transition-all duration-150 outline-none focus-visible:ring-2 focus-visible:ring-emerald-600 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 aria-invalid:border-red-700 aria-invalid:ring-red-700/20 [&_svg]:pointer-events-none [&_svg]:shrink-0 active:scale-[0.98]",
  {
    defaultVariants: {
      size: "default",
      variant: "default",
    ...
    variants: {
      ...
      variant: {
        default:
          "bg-stone-950 text-white hover:bg-stone-800 dark:bg-stone-100 dark:text-stone-950 dark:hover:bg-stone-200 shadow-sm",
        destructive:
