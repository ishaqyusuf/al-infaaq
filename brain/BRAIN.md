...
- Use `brain/engineering/coding-standards.md` for implementation-facing Midday, tRPC, form, shadcn, notification, and URL standards.
- Use `brain/engineering/repo-structure.md` for required route, table, sheet, and shared dashboard component conventions.
- Use `brain/system/reference-projects.md` for absolute local reference project paths.
